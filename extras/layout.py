...
"background-color: rgb(50, 50, 70);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.displaySelection_Menu2.setItemText(0, _translate("MainWindow", "Select Component"))
        self.displaySelection_Menu2.setItemText(1, _translate("MainWindow", "FT Magnitude"))
        self.displaySelection_Menu2.setItemText(2, _translate("MainWindow", "FT Phase"))
        self.displaySelection_Menu2.setItemText(3, _translate("MainWindow", "FT Real component"))
        self.displaySelection_Menu2.setItemText(4, _translate("MainWindow", "FT Imaginary component"))
        self.image1_label.setText(_translate("MainWindow", " Image 1"))
        self.displaySelection_Menu1.setItemText(0, _translate("MainWindow", "Select Component"))
        self.displaySelection_Menu1.setItemText(1, _translate("MainWindow", "FT Magnitude"))
        self.displaySelection_Menu1.setItemText(2, _translate("MainWindow", "FT Phase"))
        self.displaySelection_Menu1.setItemText(3, _translate("MainWindow", "FT Real component"))
        self.displaySelection_Menu1.setItemText(4, _translate("MainWindow", "FT Imaginary component"))
        self.output2_label.setText(_translate("MainWindow", "Output 2"))
        self.output1_label.setText(_translate("MainWindow", "Output 1"))
        self.Comp1_ImageMenu.setItemText(0, _translate("MainWindow", "Choose an image"))
        self.Comp1_ImageMenu.setItemText(1, _translate("MainWindow", "Image 1"))
        self.Comp1_ImageMenu.setItemText(2, _translate("MainWindow", "Image 2"))
        self.Output_menu.setItemText(0, _translate("MainWindow", "Choose output window"))
        ...
        self.Comp2_ImageMenu.setItemText(0, _translate("MainWindow", "Choose an image"))
        self.Comp2_ImageMenu.setItemText(1, _translate("MainWindow", "Image 1"))
        self.Comp2_ImageMenu.setItemText(2, _translate("MainWindow", "Image 2"))
        self.Comp2_Menu.setItemText(0, _translate("MainWindow", "Select Component"))
        ...
        self.Comp2_Menu.setItemText(5, _translate("MainWindow", "Uniform magnitude"))
        self.Comp2_Menu.setItemText(6, _translate("MainWindow", "Uniform phase"))
        ...
        self.Comp1_Menu.setItemText(0, _translate("MainWindow", "Select Component"))
        ...
        self.Comp1_Menu.setItemText(5, _translate("MainWindow", "Uniform magnitude"))
        self.Comp1_Menu.setItemText(6, _translate("MainWindow", "Uniform phase"))
