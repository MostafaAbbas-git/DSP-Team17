...
"background-color: rgb(30, 30, 50);")
        ...
        self.img2_layout.addWidget(self.output1_Display, 1, 0, 1, 1)
        self.selectedDisplay_2 = QtWidgets.QGraphicsView(self.centralwidget)
...
"font: 9pt \"MS Shell Dlg 2\";")
        ...
        self.fixedDisplay_1 = QtWidgets.QGraphicsView(self.centralwidget)
...
"font: 9pt \"MS Shell Dlg 2\";")
        ...
        self.selectedDisplay_1 = QtWidgets.QGraphicsView(self.centralwidget)
        ...
        self.Output_layout.addWidget(self.graphicsView_5, 24, 0, 1, 1)
...
"")
        ...
        self.Component_2Line = QtWidgets.QLineEdit(self.centralwidget)
        self.Component_2Line.setStyleSheet("font: 75 11pt \"MS Shell Dlg 2\";")
        self.Component_2Line.setObjectName("Component_2Line")
        self.Output_layout.addWidget(self.Component_2Line, 12, 0, 1, 1)
...
"background-color: rgb(45, 45, 70);")
        ...
        self.MixerOutputLine = QtWidgets.QLineEdit(self.centralwidget)
        self.MixerOutputLine.setStyleSheet("font: 75 12pt \"MS Shell Dlg 2\";\n"
"border-color: rgb(0, 0, 0);")
        self.MixerOutputLine.setObjectName("MixerOutputLine")
        self.Output_layout.addWidget(self.MixerOutputLine, 1, 0, 1, 1)
        self.Component_1Line = QtWidgets.QLineEdit(self.centralwidget)
        self.Component_1Line.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.Component_1Line.setStyleSheet("color: rgb(255, 255, 255);\n"
"background-color: rgb(30, 30, 50);\n"
"font: 75 11pt \"MS Shell Dlg 2\";")
        self.Component_1Line.setMaxLength(500)
        self.Component_1Line.setObjectName("Component_1Line")
        self.Output_layout.addWidget(self.Component_1Line, 5, 0, 1, 1)
...
"background-color: rgb(50, 50, 70);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Component_2Line.setText(_translate("MainWindow", " Component 2"))
        ...
        self.Comp1_Menu.setItemText(5, _translate("MainWindow", "Uniforf phase"))
        self.MixerOutputLine.setText(_translate("MainWindow", " Mixer output to:"))
        self.Component_1Line.setText(_translate("MainWindow", " Component 1"))
